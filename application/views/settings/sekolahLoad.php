	...
	<div class="col-lg-2 col-md-2 col-sm-12">
		<div class="faq-navigation d-flex justify-content-between flex-column mb-2 mb-md-0">
			...
			<ul class="nav nav-pills nav-left flex-column" role="tablist">
				<!-- Identitas Sekolah -->
				<li class="nav-item">
					<a class="nav-link active" id="pill-identitas-sekolah" data-bs-toggle="pill" href="#identitas-sekolah"
				...
				<!-- Lokasi Sekolah -->
				<li class="nav-item">
					<a class="nav-link" id="pill-lokasi-sekolah" data-bs-toggle="pill" href="#lokasi-sekolah" aria-expanded="true"
						role="tab">
				...
				<!-- Lokasi Sekolah -->
				<li class="nav-item">
					<a class="nav-link" id="pill-kontak-sekolah" data-bs-toggle="pill" href="#kontak-sekolah" aria-expanded="true"
						role="tab">
		...
		<div class="card">
			<div class="card-body">
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="identitas-sekolah" aria-labelledby="pill-identitas-sekolah"
						aria-expanded="true">
						<form class="validate-form" action="<?= base_url("settings/editProfilSekolah") ?>" method="POST"
							...
							<div class="d-flex">
								<a href="#" class="me-25">
									<?php if ($profilSekolah['logoSekolah'] && file_exists(FCPATH . "assets/files/images/logo/" . $profilSekolah['logoSekolah'])) { ?>
										<img src="<?= base_url('assets/'); ?>files/images/logo/<?= $profilSekolah['logoSekolah']; ?>"
											id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profil image" height="80"
											width="80" />
									<?php } else { ?>
								...
								<div class="d-flex align-items-end mt-75 ms-1">
									<div>
										...
										<input type="file" name="logoSekolah" id="account-upload" hidden
							...
							<div class="row mt-2">
								...
								<div class="col-12 col-sm-4 mb-1">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="nama-sekolah" name="namaSekolah"
											placeholder="Nama Sekolah" value="<?= $profilSekolah['namaSekolah'] ?>" required
											autocomplete="off" data-msg="Masukan Nama Sekolah" />
									</div>
								</div>
								<!-- NPSN input -->
								<div class="col-12 col-sm-2 mb-1">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="npsn" name="npsn" placeholder="NPSN"
											value="<?= $profilSekolah['npsn'] ?>" required autocomplete="off" data-msg="Masukan NPSN"
											maxlength="8"
								...
								<div class="col-12 col-sm-2 mb-1">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="nss" name="nss" placeholder="NSS"
											value="<?= $profilSekolah['nss'] ?>" required autocomplete="off" data-msg="Masukan NSS"
											maxlength="12"
											oninput="javascript:if(this.value.length>this.maxLength)this.value=this.value.slice(0, this.maxLength);" />
									</div>
								</div>
								...
								<div class="col-12 col-sm-2 mb-1">
									<div class="form-group">
										...
										<select class="select2 hide-search form-control" id="bentukPendidikan" name="bentukPendidikan"
											required autocomplete="off" data-msg="Pilih Bentuk Pendidikan">
											<optgroup label="Terpilih">
												<option value="<?= $profilSekolah['bentukPendidikan'] ?>" selected>
													<?= $profilSekolah['bentukPendidikan'] ?></option>
											</optgroup>
								...
								<div class="col-12 col-sm-2 mb-1">
									<div class="form-group">
										...
										<select class="select2 hide-search form-control" id="statusSekolah" name="statusSekolah" required
											autocomplete="off" data-msg="Pilih Status Sekolah">
											<optgroup label="Terpilih">
												<option value="<?= $profilSekolah['statusSekolah'] ?>" selected>
													<?= $profilSekolah['statusSekolah'] ?></option>
											</optgroup>
											<optgroup label="Pilih">
							...
							<div class="row mt-0">
								<div class="col-12">
									<button type="submit" name="btnIdentitasSekolah" class="btn btn-primary mt-2 mr-1">Simpan
										Perubahan</button>
										...
										<select class="select2 hide-search form-control" id="bentukPemerintah" name="bentukPemerintah"
											...
											<optgroup label="Terpilih">
												<option value="<?= $profilSekolah['bentukPemerintah'] ?>" selected>
													<?= $profilSekolah['bentukPemerintah'] ?></option>
											</optgroup>
											<optgroup label="Pilih">
