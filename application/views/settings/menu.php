    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="nav-item">
        ...
        <ul class="menu-content">
          ...
          <?php } ?>
          <?php if (is_pip_installed()) { ?>
          <li class="<?php if ($this->uri->segment(1) == "LayananPIP") {
							echo "active";
						} ?>">
            <a class="d-flex align-items-center" href="<?= base_url('LayananPIP/settings'); ?>">
              <i data-feather="circle"></i>
              <span class="menu-title text-truncate" data-i18n="PIP">Modul PIP</span>
            </a>
          </li>
          <?php } ?>
        </ul>
