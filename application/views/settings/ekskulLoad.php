      ...
      <form class="validate-form" action="<?= base_url('settings/tambahEkskul'); ?>" method="POST">
        <div class="modal-body">
          ...
          <div class="mb-1">
            ...
            <input type="text" class="form-control" id="namaEkskul" placeholder="Ekstrakurikuler" name="namaEkskul" minlength="5" data-msg="Masukan Nama Ekstrakurikuler" required autocomplete="off" />
          </div>
          <!-- Pelatih input -->
          <div class="mb-1" hidden>
            <label class="form-label" for="pelatih">Pelatih / Pembina</label>
