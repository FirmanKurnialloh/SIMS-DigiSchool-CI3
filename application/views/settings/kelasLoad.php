        ...
        <div class="modal-body">
          ...
          <?php if ($profilSekolah['bentukPendidikan'] == "SMA" || $profilSekolah['bentukPendidikan'] == "MA" || $profilSekolah['bentukPendidikan'] == "SMK") { ?>
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control" id="jurusan" placeholder="Jurusan" name="jurusan" required data-msg="Masukan Nama Jurusan" autocomplete="off" />
            </div>
          <?php } ?>
          <!-- Kelas input -->
          <div class="mb-1">
            <label class="form-label" for="kelas">Nama Kelas</label>
            <input type="text" class="form-control" id="kelas" placeholder="Nama Kelas" name="kelas" required data-msg="Masukan Nama Kelas" autocomplete="off" />
          </div>
        </div>
