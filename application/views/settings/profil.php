          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="<?= base_url('settings/' . $this->uri->segment('2')); ?>">Akun
                    <?= strtoupper($this->uri->segment('2')); ?></a>
                </li>
      ...
      <section id="profilPage">
        <div class='card card-body'>
          <div class='text-center'>
            ...
            <a href="#" id="reload" type="button" style="display: none;" class="btn btn-sm btn-primary"
