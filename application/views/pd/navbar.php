		...
		<ul class="nav navbar-nav align-items-center ms-auto">
			...
			<li class="nav-item dropdown dropdown-notification me-25">
				...
				<ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
					...
					<?php } ?>
					<li class="dropdown-menu-footer"><a class="btn btn-primary w-100" href="<?= base_url('pd/dashboard'); ?>">Lihat Semua Layanan</a></li>
				</ul>
			</li>
			<!-- END: NOTIFIKASI -->
			...
			<li class="nav-item dropdown dropdown-user">
				<a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<div class="user-nav">
						<span class="user-name fw-bolder d-none d-lg-block"><?= $profilPd['namaLengkap'] ?></span>
					...
					<span class="avatar-wrapper">
						<?php if ($profilPd['foto'] && file_exists(FCPATH . "assets/files/images/fotoSiswa/" . $profilPd['foto'])) { ?>
							<img src="<?= base_url('assets/'); ?>files/images/fotoSiswa/<?= $profilPd['foto']; ?>" alt="Avatar" height="32" width="32">
						<?php  } else { ?>
							<div class="avatar bg-light-<?= warnaPeran(getPeran($sessionRole1)); ?>">
								<div class="avatar-content"><?= namaInisial($profilPd['namaLengkap']); ?></div>
							</div>
						<?php } ?>
				...
				<div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
					<a class="dropdown-item" href="<?= base_url('pd/profil'); ?>"><i class="me-50" data-feather="user"></i> Profil</a>
