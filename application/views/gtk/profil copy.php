        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body py-2 my-25">
              <!-- header section -->
              <form class="validate-form" action="<?= base_url('gtk/editProfil'); ?>" method="POST" enctype="multipart/form-data">
                <div class="d-flex">
                  <a href="#" class="me-25">
                    <?php if (file_exists(APPPATH . "assets/files/images/fotoGuru/" . $profilGTK['id'])) { ?>
                      <img src="<?= base_url('assets/'); ?>files/images/fotoGuru/<?= $profilGTK['id']; ?>" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profil image" height="100" width="100" />
                    <?php  } else { ?>
                ...
                <div class="row mt-2 pt-50">
                  ...
                  <div class="col-12 col-sm-6 mb-1">
                    ...
                    <input type="number" class="form-control" id="nik" name="nik" placeholder="Masukan 16 Digit Angka" value="<?= $profilGTK['nik']; ?>" data-msg="Masukan 16 Digit Angka" maxlength="16" minlength="16" required />
                  </div>
                  <div class="col-12 col-sm-6 mb-1">
